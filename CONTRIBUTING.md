Contributing to Astron Core
============================

The Astron Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/astron-project/astron/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Astron Core project, and is not to be
confused with overall Astron Network Protocol consensus changes.

Whether a pull request is merged into Astron Core rests with the project merge
...
Patches that change Astron consensus rules are considerably more involved than
...
Where a patchset proposes to change the Astron consensus, it must have been
...
The project leader is the release manager for each Astron Core release.
