...
RESOURCES += src/qt/astron.qrc src/qt/astron_locale.qrc

TRANSLATIONS += src/qt/locale/astron_bg.ts \
                src/qt/locale/astron_de.ts \
                src/qt/locale/astron_en.ts \
                src/qt/locale/astron_es.ts \
                src/qt/locale/astron_fi.ts \
                src/qt/locale/astron_fr.ts \
                src/qt/locale/astron_it.ts \
                src/qt/locale/astron_ja.ts \
                src/qt/locale/astron_pl.ts \
                src/qt/locale/astron_pt.ts \
                src/qt/locale/astron_ru.ts \
                src/qt/locale/astron_sk.ts \
                src/qt/locale/astron_sv.ts \
                src/qt/locale/astron_vi.ts \
                src/qt/locale/astron_zh_CN.ts \
                src/qt/locale/astron_zh_TW.ts
