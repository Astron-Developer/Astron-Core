...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Astron features */
        {"astron", "listmasternodes", &listmasternodes, true, true, false},
        {"astron", "getmasternodecount", &getmasternodecount, true, true, false},
        {"astron", "masternodeconnect", &masternodeconnect, true, true, false},
        {"astron", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"astron", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"astron", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"astron", "masternodecurrent", &masternodecurrent, true, true, false},
        {"astron", "masternodedebug", &masternodedebug, true, true, false},
        {"astron", "startmasternode", &startmasternode, true, true, false},
        {"astron", "createmasternodekey", &createmasternodekey, true, true, false},
        {"astron", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"astron", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"astron", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"astron", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"astron", "getmasternodescores", &getmasternodescores, true, true, false},
        {"astron", "preparebudget", &preparebudget, true, true, false},
        {"astron", "submitbudget", &submitbudget, true, true, false},
        {"astron", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"astron", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"astron", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"astron", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"astron", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"astron", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"astron", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"astron", "checkbudgets", &checkbudgets, true, true, false},
        {"astron", "mnsync", &mnsync, true, true, false},
        {"astron", "spork", &spork, true, true, false},
        {"astron", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> astron-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27077/\n";
}
