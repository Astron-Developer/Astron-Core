...
/* Astron GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Astron"
#define QAPP_ORG_DOMAIN "astron.org"
#define QAPP_APP_NAME_DEFAULT "Astron-Qt"
#define QAPP_APP_NAME_TESTNET "Astron-Qt-testnet"
