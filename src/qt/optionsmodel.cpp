...
// Wallet
    ...
    if (settings.contains("nAnonymizeAstronAmount"))
        SoftSetArg("-anonymizeastronamount", settings.value("nAnonymizeAstronAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in astron.cpp during shotdown to also remove the window positions
