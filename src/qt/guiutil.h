...
/** Utility functions used by the Astron Qt UI.
 */
namespace GUIUtil
{
...
// Render Astron addresses in monospace font
...
// Parse "astron:" URI into recipient object, return true on successful parsing
