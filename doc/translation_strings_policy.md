...
This document provides guidelines for internationalization of the Astron Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Astron network</numerusform>
            <numerusform>%n active connections to Astron network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `astron_en.ts` remains unchanged.
